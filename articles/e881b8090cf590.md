...
ツイート文を省略すると「にゃーん」とツイートする謎機能があります。
...
Twitter API v2に振り回されつつも、活発に開発を続けています。
Zennに記事も書きました。
...
GitHub CLIのコマンドにaliasを貼って運用していたのですが、編集や削除の際にIssue番号を指定するのが手間に感じたので作りました。
