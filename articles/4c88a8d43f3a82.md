...
[コミュニティの投稿](https://twittercommunity.com/t/cannot-use-oauth2-with-pkce-access-token-on-multiple-devices/174692) にもあるように、「A でログインした後に B でログインすると、A のトークンが失効する」いう挙動になってしまいます。
...
### ツイートを自分がいいね・RT しているかどうかが取得できない
